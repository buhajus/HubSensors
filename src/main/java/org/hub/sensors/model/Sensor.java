...
public class Sensor {
    ...
    public Sensor(String sensorName, String sensorLocation, int status, String date) {
    ...
    public Sensor(int id, String sensorName, String sensorLocation, int status, String date) {
        this.id = id;
        this.sensorName = sensorName;
        this.sensorLocation = sensorLocation;
        this.status = status;
